    ...
    <div class="mainBody">
      <div class="common clearfix">
        ...
        <div class="mainBody-left">
          ...
          <!-- 原回答标签 top -->
          <div class="All-card" @click="allJump">
            <a class="viewAll" href="javascript:;">查看全部 {{questionTotal}} 个回答</a>
          </div>
          <!-- 回答总数 -->
          ...
          >
            <div class="view-comment clearfix">
              <div class="list-header" v-if="index == 1">
                <h4>更多回答</h4>
              </div>
              <!-- 头像 -->
        ...
        <div class="mainBody-right">
          ...
          <div class="AboutBlogger">
            <div class="writerTitle" style="text-align:center">作者</div>
  ...
  methods: {
    ...
    async getquestionList(sortway) {
      ...
      if (res.code != 200) {
        ...
        let answer_id = this.$route.params.aid;

        // 只获取回答用户的回答
        let index = res.data.findIndex(item => item.id == answer_id);
        if (index == -1) {
          return this.$router.push("/error");
        }
        console.log(index);
        let theAnswer = res.data[index];
        res.data.splice(index, 1);
        res.data.unshift(theAnswer);
        res.data.splice(3);
